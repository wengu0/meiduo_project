...
SECRET_KEY = 'rpzj8@jgkg&#_d8%!vjcjv+=pady84229%x@_9ubicrh*uas_k'
...
LOGGING = {
    ...
    'handlers': {  # 日志处理方法
        ...
        'file': {  # 向文件中输出日志
            ...
            'filename': os.path.join(os.path.join(BASE_DIR), "logs/meiduo.log"),  # 日志文件的位置
